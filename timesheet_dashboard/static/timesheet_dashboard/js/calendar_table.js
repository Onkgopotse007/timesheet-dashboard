$(document).ready(function () {
    ...
    var is_security = JSON.parse(document.getElementById('is_security').textContent);
    ...
    var is_weekend = function (year, month, day) {
        ...
        if (!is_security && dt.getDay() === 6 || dt.getDay() === 0) {
            return true;
        }
    }
    ...
    function tableRows(value) {
        ...
        } else if (!is_security && is_weekend(curr_year, curr_month, day)) {
        ...
        if (day <= last_day) {
            markup += "<td> " +
                ...
                "<div class='input-group'> <input id='dailyentry_set-" + value + "-duration_minutes' type='number' value='0' class='form-control form-control-sm' name='dailyentry_set-" + value + "-duration_minutes' max='59' min='0' style='width:48px; padding:4px 8px; border-right:0;'/>" +
