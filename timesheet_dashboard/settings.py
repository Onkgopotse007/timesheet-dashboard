"""
Django settings for timesheet_dashboard project.
...
SECRET_KEY = 'k#5+wv103w5ovv@64z=^x3sbvkla3i$*jdswpuc@m(^%spa-ht'
...
WSGI_APPLICATION = 'timesheet_dashboard.wsgi.application'
